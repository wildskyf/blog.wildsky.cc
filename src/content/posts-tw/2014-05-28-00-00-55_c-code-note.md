...
"
feature_image: "cli-on-dell-xps.jpg"
feature_image_caption: "明明本文說的是 Windows 專用的指令，硬是要放一張 Ubutnu 的 command line 畫面XD"
...
<div role="alert" className="alert alert-warning opacity-70">
  ...
  <span>本篇提及的內容僅適用 Windows 作業系統。</span>
</div>
...
P.S : `system("color 0F");` 是黑底白字，`system("color F0");` 是白底白黑字，剩下的自行推算看看吧。
...
有了上面那幾個函式，相信就可以大大地改善使用者介面了，更不用提程式碼會變得多整潔。如果想製作命令列小遊戲，有了上面那兩個函式也會變得很容易。

## 參考

- <http://kowala21.blogspot.com/2012/01/dev-c-console.html>
- <http://flyingdc.pixnet.net/blog/post/24333750>
